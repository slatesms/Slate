# Counselor — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`counselor.md`](../counselor.md).

---

## At a glance

Counselors have access to student counseling records, interventions, appointments, and academic planning.
...
- After you sign in, go to your **Counselor** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/counselor`.
...
- Use the left navigation in order for routine work: Students, then Appointments, then Interventions, then Session Notes. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`counselor.md`](../counselor.md)
