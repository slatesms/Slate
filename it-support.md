# IT Support — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`it-support.md`](../it-support.md).

---

## At a glance

This role uses the **IT Support** dashboard to complete school (or governance) work assigned to this role. Your **exact** screens may depend on what your school enables.
...
- After you sign in, go to your **IT Support** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/it-support`.
...
- **All screens, routes, and permissions (reference):** [`it-support.md`](../it-support.md)
