# Guest Lecturer — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`guest-lecturer.md`](../guest-lecturer.md).

---

## At a glance

Guest lecturers have temporary access to assigned courses for teaching and assessment purposes. They have similar permissions to teachers but with temporary/limited scope.
...
- After you sign in, go to your **Guest Lecturer** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/guest-lecturer`.
...
- Use the left navigation in order for routine work: Analytics, then Activities, then My Classes, then Attendance. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`guest-lecturer.md`](../guest-lecturer.md)
