# Controller Of Examinations — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`controller-of-examinations.md`](../controller-of-examinations.md).

---

## At a glance

The Controller of Examinations (CoE) is responsible for all examination operations, grading workflows, evaluation processes, timetable creation, hall ticket generation, and result publishing. The CoE ensures exam integrity, manages evaluator workflows, and maintains compliance with academic standards. Description: "Oversees exam operations, grading workflows, evaluation processes, timetable creation, hall ticket generation, and result publishing"
...
- After you sign in, go to your **Controller Of Examinations** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/controller-of-examinations`.
...
- **Your area in general** (policies, big picture): [`01-Leadership-and-Institution-Admins.md`](../../01-Leadership-and-Institution-Admins.md)
- **All screens, routes, and permissions (reference):** [`controller-of-examinations.md`](../controller-of-examinations.md)
