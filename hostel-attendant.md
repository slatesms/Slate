# Hostel Attendant — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`hostel-attendant.md`](../hostel-attendant.md).

---

## At a glance

The Hostel Attendant supports hostel wardens in day-to-day accommodation operations, including room allocation assistance, student check-ins/outs, maintenance coordination, cleanliness tracking, hostel attendance, grievance logging, and hostel resource management. Responsibilities include: - Accommodation management (room & bed allocation support)
...
- After you sign in, go to your **Hostel Attendant** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/hostel-attendant`.
...
- Use the left navigation in order for routine work: Students & allocation, then Check-In / Check-Out, then Attendance & roll call, then Leave & out-pass. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`hostel-attendant.md`](../hostel-attendant.md)
