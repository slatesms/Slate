# Zone Admin — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`zone-admin.md`](../zone-admin.md).

---

## At a glance

This role uses the **Zone Admin** dashboard to complete school (or governance) work assigned to this role. Your **exact** screens may depend on what your school enables.
...
- **All screens, routes, and permissions (reference):** [`zone-admin.md`](../zone-admin.md)
