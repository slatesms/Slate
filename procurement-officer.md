# Procurement Officer — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`procurement-officer.md`](../procurement-officer.md).

---

## At a glance

The Procurement Officer manages the complete lifecycle of institutional purchasing, including purchase requests, vendor management, quotations, purchase orders, GRN, delivery tracking, and payment coordination with the accountant. Description: "Manages purchase orders, vendors, asset acquisition, quotations, and procurement workflows for the institution"
...
- After you sign in, go to your **Procurement Officer** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/procurement-officer`.
...
- Use the left navigation in order for routine work: Purchase Requests, then Quotations, then Comparison Sheets, then Negotiation Notes. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`procurement-officer.md`](../procurement-officer.md)
