# Substitute Teacher — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`substitute-teacher.md`](../substitute-teacher.md).

---

## At a glance

Substitute teachers have temporary access to assigned classes for grade entry and attendance tracking during their assignment period.
...
- After you sign in, go to your **Substitute Teacher** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/substitute-teacher`.
...
- Use the left navigation in order for routine work: Activities, then My Classes, then Attendance, then Assignments. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`substitute-teacher.md`](../substitute-teacher.md)
