# PE Teacher — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`pe-teacher.md`](../pe-teacher.md).

---

## At a glance

PE teachers have similar permissions to regular teachers, with focus on physical education classes and sports activities.
...
- After you sign in, go to your **PE Teacher** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/pe-teacher`.
...
- **All screens, routes, and permissions (reference):** [`pe-teacher.md`](../pe-teacher.md)
