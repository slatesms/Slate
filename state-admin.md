# State Admin — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`state-admin.md`](../state-admin.md).

---

## At a glance

State admins manage education at state level: districts, subdistricts, schools, governance users, analytics, policies, infrastructure, finance, teacher workforce, reports, and state-level communication (email templates, messaging, payroll view, training enrollments). All data is scoped by state_id (multi-tenant). Role Code: state-admin

---

## Sign in and open the right place

- Use the **link and tenant code** your administrator gave you. Governance dashboards use the same app pattern, but the segment in the URL is your **state, district, or zone** (not a school).
- If you are unsure which URL to use, ask your **state/district/zone** administrator or IT contact.
...
- **I am state, district, or zone staff and I do not see a school screen.** That can be normal: governance is scoped to your level. If you *should* have school access, ask your governance lead or IT to confirm your **role and tenant**.

## Need more detail?

- **Your area in general** (policies, big picture): [`08-Governance-State-District-Zone.md`](../../08-Governance-State-District-Zone.md)
- **All screens, routes, and permissions (reference):** [`state-admin.md`](../state-admin.md)
