# Super Admin — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`super-admin.md`](../super-admin.md).

---

## At a glance

This role uses the **Super Admin** dashboard to complete school (or governance) work assigned to this role. Your **exact** screens may depend on what your school enables.
...
- After you sign in, go to your **Super Admin** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/super-admin`.
...
- **All screens, routes, and permissions (reference):** [`super-admin.md`](../super-admin.md)
