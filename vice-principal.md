# Vice Principal — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`vice-principal.md`](../vice-principal.md).

---

## At a glance

Vice principals have similar permissions to principals but with some additional creation capabilities for staff and students.
...
- After you sign in, go to your **Vice Principal** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/vice-principal`.
...
- Work **approvals and queues** first: **Staff Approvals**, **Student Approvals** — clear or delegate before new intake.
- Use the left navigation in order for routine work: Analytics, then Activities, then Staff, then Staff Approvals. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`vice-principal.md`](../vice-principal.md)
