# PTA Member — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`pta-member.md`](../pta-member.md).

---

## At a glance

Represents parents in PTA committees, collaborates with school leadership, voices parent concerns, participates in school improvement planning, monitors student welfare initiatives, and supports community-school engagement activities. Responsibilities: - Parent representation & voice
...
- After you sign in, go to your **PTA Member** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/pta-member`.
...
- **All screens, routes, and permissions (reference):** [`pta-member.md`](../pta-member.md)
