# Medical Officer — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`medical-officer.md`](../medical-officer.md).

---

## At a glance

The Medical Officer is responsible for student and staff medical services, emergency response, health record management, health screenings, wellness programs, and coordination with hospital/ambulance services. Responsibilities include: - Campus clinic operations (OPD, appointments, walk-ins)
...
- After you sign in, go to your **Medical Officer** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/medical-officer`.
...
- Use the left navigation in order for routine work: OPD & Appointments, then Medical Records, then Emergency Cases, then Medication Inventory. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`medical-officer.md`](../medical-officer.md)
