# Tech Support — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`tech-support.md`](../tech-support.md).

---

## At a glance

Tech support staff manage support tickets, system monitoring, user support, knowledge base, and device management.
...
- After you sign in, go to your **Tech Support** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/tech-support`.
...
- Use the left navigation in order for routine work: Tickets, then Analytics, then Activities, then Open Tickets. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`tech-support.md`](../tech-support.md)
