# Alumni — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`alumni.md`](../alumni.md).

---

## At a glance

Alumni (Former students) have limited access to their own academic records, transcripts, certificates, messaging, and can enroll in training programs. They can view their own payroll if applicable.
...
- After you sign in, go to your **Alumni** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/alumni`.
...
- **All screens, routes, and permissions (reference):** [`alumni.md`](../alumni.md)
