# Teacher — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`teacher.md`](../teacher.md).

---

## At a glance

Teachers have access to their assigned classes, students, assessments, grades, and attendance. They can communicate with students and parents.
...
- After you sign in, go to your **Teacher** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/teacher`.
...
- **All screens, routes, and permissions (reference):** [`teacher.md`](../teacher.md)
