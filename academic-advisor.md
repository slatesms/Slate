# Academic Advisor — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`academic-advisor.md`](../academic-advisor.md).

---

## At a glance

The Academic Advisor guides students on course selection, academic planning, and progress monitoring. They support students in their academic journey through counseling, planning, and performance tracking. Description: "Guides students on course selection, academic planning, and progress monitoring"
...
- After you sign in, go to your **Academic Advisor** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/academic-advisor`.
...
- **All screens, routes, and permissions (reference):** [`academic-advisor.md`](../academic-advisor.md)
