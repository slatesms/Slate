# Transportation Coordinator — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`transportation-coordinator.md`](../transportation-coordinator.md).

---

## At a glance

The Transportation Coordinator manages all transportation logistics including campus shuttle services, student/staff route assignments, vehicle fleets, drivers, schedules, safety checks, GPS tracking, and transport billing. Responsibilities include: - Campus shuttle & route management
...
- After you sign in, go to your **Transportation Coordinator** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/transportation-coordinator`.
...
- **All screens, routes, and permissions (reference):** [`transportation-coordinator.md`](../transportation-coordinator.md)
