# Head of Department (HOD) — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`hod.md`](../hod.md).

---

## At a glance

Head of Department (HOD) Role Permissions HODs have oversight of their department, including staff management, course management, academic planning, and performance analytics.
...
- After you sign in, go to your **Head of Department (HOD)** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/hod`.
...
- Open **Overview** to see your home view; confirm the correct **school** (or governance tenant) is selected.
- Work **approvals and queues** first: **Pending Approvals** — clear or delegate before new intake.
- Use the left navigation in order for routine work: Analytics, then Activities, then Department Staff, then Department Info. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`hod.md`](../hod.md)
