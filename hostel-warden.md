# Hostel Warden — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`hostel-warden.md`](../hostel-warden.md).

---

## At a glance

Hostel wardens manage residents, rooms, facilities, meals, security, maintenance, check-ins, and check-outs.
...
- After you sign in, go to your **Hostel Warden** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/hostel-warden`.
...
- Use the left navigation in order for routine work: Residents, then Rooms, then Facilities, then Meals. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`hostel-warden.md`](../hostel-warden.md)
