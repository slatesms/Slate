# MIS Officer — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`mis-officer.md`](../mis-officer.md).

---

## At a glance

Manages institutional MIS operations, reporting, dashboards, data consolidation, analytics pipelines, KPIs, compliance reporting, and ensures accurate multi-department data flow for informed decision-making. Responsibilities: - Data Management & Consolidation
...
- After you sign in, go to your **MIS Officer** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/mis-officer`.
...
- **All screens, routes, and permissions (reference):** [`mis-officer.md`](../mis-officer.md)
