# Dean — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`dean.md`](../dean.md).

---

## At a glance

The Dean is the senior academic head responsible for academic leadership, faculty oversight, department performance, curriculum quality, accreditation readiness, and institutional excellence within their faculty/school. Description: "Senior academic head overseeing faculties or schools within the university"
...
- After you sign in, go to your **Dean** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/dean`.
...
- **All screens, routes, and permissions (reference):** [`dean.md`](../dean.md)
