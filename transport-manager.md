# Transport Manager — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`transport-manager.md`](../transport-manager.md).

---

## At a glance

Transport managers manage transportation routes, vehicles, drivers, and student transportation assignments.
...
- After you sign in, go to your **Transport Manager** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/transport-manager`.
...
- Use the left navigation in order for routine work: Analytics, then Activities, then Vehicles, then Routes. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`transport-manager.md`](../transport-manager.md)
