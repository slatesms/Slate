# Sports Coordinator — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`sports-coordinator.md`](../sports-coordinator.md).

---

## At a glance

Sports coordinators manage all sports activities, teams, competitions, and coordinate with coaches and athletes.
...
- After you sign in, go to your **Sports Coordinator** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/sports-coordinator`.
...
- Use the left navigation in order for routine work: Analytics, then Activities, then Tournaments, then Teams. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`sports-coordinator.md`](../sports-coordinator.md)
