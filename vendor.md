# Vendor — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`vendor.md`](../vendor.md).

---

## At a glance

Vendors have limited access for managing their vendor profile and viewing relevant procurement information. They also have read access to student data for procurement-related operations.
...
- After you sign in, go to your **Vendor** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/vendor`.
...
- Use the left navigation in order for routine work: Analytics, then Activities, then Orders, then Products. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`vendor.md`](../vendor.md)
