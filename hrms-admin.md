# HRMS Admin — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`hrms-admin.md`](../hrms-admin.md).

---

## At a glance

HRMS admins manage staff records, HRMS functions, leave, performance, training, benefits, and payroll.
...
- After you sign in, go to your **HRMS Admin** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/hrms-admin`.
...
- Work **approvals and queues** first: **Pending Approval** — clear or delegate before new intake.
- Use the left navigation in order for routine work: Analytics, then Activities, then Staff Attendance, then All Requests. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`hrms-admin.md`](../hrms-admin.md)
