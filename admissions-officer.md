# Admissions Officer — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`admissions-officer.md`](../admissions-officer.md).

---

## At a glance

Admissions officers manage student admissions, applications, and transcripts.
...
- After you sign in, go to your **Admissions Officer** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/admissions-officer`.
...
- Use the left navigation in order for routine work: Analytics, then Activities, then All Leads, then New Lead. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`admissions-officer.md`](../admissions-officer.md)
