# Compliance Officer — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`compliance-officer.md`](../compliance-officer.md).

---

## At a glance

The Compliance Officer ensures the institution's continuous readiness for accreditation, audits, inspections, statutory filings, policy documentation, reporting & regulatory updates. Responsibilities include: - NAAC, NBA, AICTE, UGC accreditation management - Evidence & document management
...
- After you sign in, go to your **Compliance Officer** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/compliance-officer`.
...
- Use the left navigation in order for routine work: Accreditation Cycles, then Criteria & Metrics, then SSR Forms, then SAR Forms. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`compliance-officer.md`](../compliance-officer.md)
