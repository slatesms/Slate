# Photographer — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`photographer.md`](../photographer.md).

---

## At a glance

Photographer — school-level media capture, upload, assignment, and gallery workflows. Restricted to identity fields and media operations; no academic/financial access.
...
- After you sign in, go to your **Photographer** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/photographer`.
...
- **Your area in general** (policies, big picture): [`07-Photographer-and-School-Media.md`](../../07-Photographer-and-School-Media.md)
- **All screens, routes, and permissions (reference):** [`photographer.md`](../photographer.md)
