# Support Staff — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`support-staff.md`](../support-staff.md).

---

## At a glance

Support staff have basic access for their role, including self-service HRMS features and limited system access.
...
- After you sign in, go to your **Support Staff** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/support-staff`.
...
- Use the left navigation in order for routine work: Analytics, then Activities, then Tasks, then Maintenance. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`support-staff.md`](../support-staff.md)
