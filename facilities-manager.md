# Facilities Manager — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`facilities-manager.md`](../facilities-manager.md).

---

## At a glance

Facilities managers manage school facilities, maintenance requests, and facility bookings.
...
- After you sign in, go to your **Facilities Manager** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/facilities-manager`.
...
- Use the left navigation in order for routine work: Facilities, then Maintenance, then Resources, then Inspections. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`facilities-manager.md`](../facilities-manager.md)
