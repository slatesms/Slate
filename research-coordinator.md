# Research Coordinator — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`research-coordinator.md`](../research-coordinator.md).

---

## At a glance

The Research Coordinator oversees research projects, grants, and thesis submissions for the institution. Coordinates proposals, ethics approvals, research tracking, scholar progress, and publication workflows. Description: "Oversees research projects, grants, and thesis submissions for the institution. Coordinates proposals, ethics approvals, research tracking, scholar progress, and publication workflows."
...
- After you sign in, go to your **Research Coordinator** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/research-coordinator`.
...
- **All screens, routes, and permissions (reference):** [`research-coordinator.md`](../research-coordinator.md)
