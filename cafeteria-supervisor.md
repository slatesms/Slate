# Cafeteria Supervisor — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`cafeteria-supervisor.md`](../cafeteria-supervisor.md).

---

## At a glance

Supervises cafeteria operations, food service, meal planning, inventory, hygiene compliance, staff coordination, and ensures smooth dining services for students and staff. Responsibilities: - Daily meal service operations - Meal menu planning & management
...
- After you sign in, go to your **Cafeteria Supervisor** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/cafeteria-supervisor`.
...
- **All screens, routes, and permissions (reference):** [`cafeteria-supervisor.md`](../cafeteria-supervisor.md)
