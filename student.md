# Student — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`student.md`](../student.md).

---

## At a glance

Students have access to their own academic records, courses, grades, attendance, and can communicate with teachers.
...
- After you sign in, go to your **Student** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/student`.
...
- Use the left navigation in order for routine work: Courses, then Schedule, then Assignments, then Grades. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`student.md`](../student.md)
