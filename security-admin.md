# Security Admin — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`security-admin.md`](../security-admin.md).

---

## At a glance

Security admins manage biometric devices, badge systems, security devices, and access control. They have read-only access to attendance logs.
...
- After you sign in, go to your **Security Admin** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/security-admin`.
...
- Use the left navigation in order for routine work: Activity Logs, then Devices, then Templates, then Enrollment Stats. Finish one record (save, then confirm) before switching screens.
...
- **Your area in general** (policies, big picture): [`05-Technology-Security-and-Support.md`](../../05-Technology-Security-and-Support.md)
- **All screens, routes, and permissions (reference):** [`security-admin.md`](../security-admin.md)
