# Quality Assurance Officer — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`quality-assurance-officer.md`](../quality-assurance-officer.md).

---

## At a glance

Conducts audits, inspections, compliance verification, quality benchmarking, accreditation readiness, institutional process evaluation, safety audits, academic quality monitoring, and ensures that the institution adheres to internal policies, educational standards, and statutory board requirements. Responsibilities:
...
- After you sign in, go to your **Quality Assurance Officer** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/quality-assurance-officer`.
...
- **All screens, routes, and permissions (reference):** [`quality-assurance-officer.md`](../quality-assurance-officer.md)
