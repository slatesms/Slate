# Discipline Coordinator — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`discipline-coordinator.md`](../discipline-coordinator.md).

---

## At a glance

Handles discipline cases, monitors student conduct, manages behavior interventions, maintains incident records, enforces campus discipline policy, and coordinates with parents, teachers, counselors, and school administrators.
...
- After you sign in, go to your **Discipline Coordinator** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/discipline-coordinator`.
...
- **All screens, routes, and permissions (reference):** [`discipline-coordinator.md`](../discipline-coordinator.md)
