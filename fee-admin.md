# Fee Admin — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`fee-admin.md`](../fee-admin.md).

---

## At a glance

Fee admins manage fee structures, payments, outstanding fees, and refunds.
...
- After you sign in, go to your **Fee Admin** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/fee-admin`.
...
- Use the left navigation in order for routine work: Analytics, then Activities, then Fee Structures, then Outstanding Fees. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`fee-admin.md`](../fee-admin.md)
