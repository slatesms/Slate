# Nurse — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`nurse.md`](../nurse.md).

---

## At a glance

The Nurse provides first-level medical care, handles daily clinic operations, logs routine OPD cases, manages first-aid & vital signs, maintains medicine issue logs, assists in emergencies, updates medical records under supervision, and supports the Medical Officer across clinic, screening, and surveillance workflows. Responsibilities include: - Basic clinic support (walk-ins, vital signs, first-aid)
...
- After you sign in, go to your **Nurse** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/nurse`.
...
- Work **approvals and queues** first: **Approvals** — clear or delegate before new intake.
- Use the left navigation in order for routine work: Clinic visits (OPD), then Vitals monitoring, then Student health, then Emergencies. Finish one record (save, then confirm) before switching screens.
...
- **Your area in general** (policies, big picture): [`03-Student-Services-and-Wellbeing.md`](../../03-Student-Services-and-Wellbeing.md)
- **All screens, routes, and permissions (reference):** [`nurse.md`](../nurse.md)
