# Program Coordinator — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`program-coordinator.md`](../program-coordinator.md).

---

## At a glance

The Program Coordinator is responsible for execution of academic programs, curriculum planning, course allocation, faculty coordination, student advising, and academic quality at the program level. Description: "Manages specific academic programs, curriculum implementation, course planning, faculty coordination, and academic workflow execution."
...
- After you sign in, go to your **Program Coordinator** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/program-coordinator`.
...
- **All screens, routes, and permissions (reference):** [`program-coordinator.md`](../program-coordinator.md)
