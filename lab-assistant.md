# Lab Assistant — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`lab-assistant.md`](../lab-assistant.md).

---

## At a glance

The Lab Assistant supports computer, engineering, and science labs with equipment management, lab session readiness, safety compliance, repairs, consumables tracking, and coordination with teachers. Responsibilities include: - Lab inventory and asset management - Consumables stock tracking
...
- After you sign in, go to your **Lab Assistant** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/lab-assistant`.
...
- Use the left navigation in order for routine work: Inventory, then Consumables, then Lab Schedule, then Safety Management. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`lab-assistant.md`](../lab-assistant.md)
