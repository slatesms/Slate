# E Learning Admin — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`e-learning-admin.md`](../e-learning-admin.md).

---

## At a glance

The E-Learning Admin manages the entire digital learning ecosystem across the institution, ensuring smooth LMS operations, high-quality digital content, integration of external learning platforms, online assessments & grading workflows, teacher/student onboarding & training, and digital course structures and curriculum mapping. Responsibilities include:
...
- After you sign in, go to your **E Learning Admin** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/e-learning-admin`.
...
- Use the left navigation in order for routine work: Content Library, then Courses, then Modules, then Lessons. Finish one record (save, then confirm) before switching screens.
...
- **Your area in general** (policies, big picture): [`02-Academics-and-Teaching.md`](../../02-Academics-and-Teaching.md)
- **All screens, routes, and permissions (reference):** [`e-learning-admin.md`](../e-learning-admin.md)
