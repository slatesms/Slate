# Events Coordinator — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`events-coordinator.md`](../events-coordinator.md).

---

## At a glance

Responsible for planning, organizing, scheduling, and managing institutional events, cultural programs, competitions, celebrations, parent-teacher gatherings, student activities, and major school functions. Ensures proper coordination with departments, logistics, budgets, communication, and event execution.
...
- After you sign in, go to your **Events Coordinator** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/events-coordinator`.
...
- **All screens, routes, and permissions (reference):** [`events-coordinator.md`](../events-coordinator.md)
