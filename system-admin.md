# System Admin — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`system-admin.md`](../system-admin.md).

---

## At a glance

System admins have administrative access to system settings, user management, and system configuration. Similar to slate-admin but school-specific.
...
- After you sign in, go to your **System Admin** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/system-admin`.
...
- Use the left navigation in order for routine work: Analytics, then Activity Log, then System Settings, then User Management. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`system-admin.md`](../system-admin.md)
