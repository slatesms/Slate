# Internship Coordinator — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`internship-coordinator.md`](../internship-coordinator.md).

---

## At a glance

The Internship Coordinator manages the end-to-end lifecycle of student internships, including opportunities, applications, approvals, attendance, reporting, evaluations, and completion certificates. Description: "Coordinates student internships, approvals, and evaluations"
...
- After you sign in, go to your **Internship Coordinator** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/internship-coordinator`.
...
- **All screens, routes, and permissions (reference):** [`internship-coordinator.md`](../internship-coordinator.md)
