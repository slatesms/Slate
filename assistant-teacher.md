# Assistant Teacher — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`assistant-teacher.md`](../assistant-teacher.md).

---

## At a glance

Assistant teachers have limited access to assigned classes, with grade entry and attendance tracking capabilities.
...
- After you sign in, go to your **Assistant Teacher** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/assistant-teacher`.
...
- **All screens, routes, and permissions (reference):** [`assistant-teacher.md`](../assistant-teacher.md)
