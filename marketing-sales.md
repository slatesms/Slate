# Marketing Sales — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`marketing-sales.md`](../marketing-sales.md).

---

## At a glance

Marketing & Sales Role Permissions The Marketing & Sales Officer manages all institutional marketing, student recruitment, lead generation, and campaign analytics. This includes marketing campaigns, digital presence, social media management, lead tracking, outreach programs, partnerships, budgeting, and comprehensive marketing analytics.
...
- After you sign in, go to your **Marketing Sales** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/marketing-sales`.
...
- Use the left navigation in order for routine work: Campaigns, then Social Media, then Lead Generation, then Outreach & Events. Finish one record (save, then confirm) before switching screens.
...
- **Your area in general** (policies, big picture): [`06-Community-External-and-Engagement.md`](../../06-Community-External-and-Engagement.md)
- **All screens, routes, and permissions (reference):** [`marketing-sales.md`](../marketing-sales.md)
