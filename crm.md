# CRM — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`crm.md`](../crm.md).

---

## At a glance

The CRM Officer manages the entire lead lifecycle—collection, follow-ups, communication, counseling, demo scheduling, pipeline movement, and conversion. Ensures proper engagement with prospective parents/students and maintains accurate CRM records. Description: "Manages the entire lead lifecycle—collection, follow-ups, communication, counseling, demo scheduling, pipeline movement, and conversion. Ensures proper engagement
...
- After you sign in, go to your **CRM** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/crm`.
...
- Use the left navigation in order for routine work: Lead Inbox, then Pipeline, then Follow-ups, then Communication. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`crm.md`](../crm.md)
