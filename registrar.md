# Registrar — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`registrar.md`](../registrar.md).

---

## At a glance

The Registrar is the central authority for academic records, admissions processing, student verification, and all official document issuance including transcripts, certificates, enrollment letters, and migration documents. Description: "Manages student records, registration processes, transcripts, academic documents, certifications, migrations, and enrollment data"
...
- After you sign in, go to your **Registrar** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/registrar`.
...
- **All screens, routes, and permissions (reference):** [`registrar.md`](../registrar.md)
