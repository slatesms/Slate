# Librarian — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`librarian.md`](../librarian.md).

---

## At a glance

Librarians manage library resources, catalog, circulation, checkouts, and returns.
...
- After you sign in, go to your **Librarian** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/librarian`.
...
- Use the left navigation in order for routine work: Catalog, then Circulation, then Members, then Reports. Finish one record (save, then confirm) before switching screens.
...
- **All screens, routes, and permissions (reference):** [`librarian.md`](../librarian.md)
