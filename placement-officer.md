# Placement Officer — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`placement-officer.md`](../placement-officer.md).

---

## At a glance

The Placement Officer manages internships, placements, corporate partnerships, job drives, employer relations, and student career services for the institution. Description: "Manages internships, placements, corporate partnerships, job drives, employer relations, and student career services for the institution."
...
- After you sign in, go to your **Placement Officer** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/placement-officer`.
...
- **All screens, routes, and permissions (reference):** [`placement-officer.md`](../placement-officer.md)
