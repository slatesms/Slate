# Career Counselor — your SlateSMS dashboard (easy guide)

This page is the **end-user** version. A more technical list of screens and permissions is in [`career-counselor.md`](../career-counselor.md).

---

## At a glance

Guides students on academics, career pathways, stream/subject selection, skill-building, psychometric evaluation, scholarship opportunities, and college admissions planning. Responsibilities: - Academic guidance & planning - Career pathway exploration
...
- After you sign in, go to your **Career Counselor** area. The address will include your **school code** and look like: `https://<your-domain>/{school_code}/dashboard/career-counselor`.
...
- **All screens, routes, and permissions (reference):** [`career-counselor.md`](../career-counselor.md)
